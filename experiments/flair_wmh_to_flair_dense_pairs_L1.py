# -*- coding: utf-8 -*-
"""
Experiment 7: FLAIR + WMH → FLAIR (dense-pairs) prediction with downstream WMH segmentation.
Using L1 loss, separate forward passes per (source, target, time_delta) pair.
"""
...
class Experiment7(BaseExperiment):
    ...
    def run(self):
        """Execute the full Experiment 7 pipeline."""
        print("\n" + "="*60)
        print("Starting Experiment 7: FLAIR + WMH → FLAIR (dense-pairs, L1 loss)")
        print("="*60 + "\n")
...
if __name__ == "__main__":
    ...
    Usage: python experiments/flair_wmh_to_flair_dense_pairs_L1.py
    """
    print("\n" + "="*70)
    print("🧪 Running Experiment 7: FLAIR + WMH → FLAIR (dense pairs, L1)")
    print("="*70 + "\n")
    ...
    experiment_config = {
        ...
        "description": "FLAIR + WMH-> FLAIR (dense pairs) prediction with L1 loss",
        "use_wmh": True,
        "class": Experiment7
    }
