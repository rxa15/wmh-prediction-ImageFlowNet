# -*- coding: utf-8 -*-
"""
Experiment 5: FLAIR + WMH → FLAIR with downstream segmentation (only using L1 loss)
"""
...
class Experiment5(BaseExperiment):
    """
    Experiment 5: FLAIR + WMH → FLAIR prediction with downstream WMH segmentation.
...
if __name__ == "__main__":
    ...
    Usage: python experiments/flair_wmh_to_flair.py
    """
    print("\n" + "="*70)
    print("🧪 Running Experiment 5: FLAIR + WMH → FLAIR (Standalone Mode)")
    print("="*70 + "\n")
    ...
    experiment_config = {
        ...
        "description": "FLAIR + WMH-> FLAIR (two-stage: prediction then segmentation, loss: L1 only)",
        "use_wmh": True,
        "class": Experiment5
    }
