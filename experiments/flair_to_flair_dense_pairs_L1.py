# -*- coding: utf-8 -*-
"""
Experiment 3: FLAIR → FLAIR (dense pairs) prediction with downstream WMH segmentation
Using L1 loss, separate forward passes per (source, target, Δt) pair
"""
...
class Experiment3(BaseExperiment):
    """
    Experiment 3: FLAIR → FLAIR (dense-pairs: ALL POSSIBLE PAIRS) prediction with downstream WMH segmentation
    Using L1 loss, separate forward passes per (source, target, Δt) pair
    """
    ...
    def run(self):
        ...
        print("\n" + "="*60)
        print("Starting Experiment 3: FLAIR → FLAIR (dense pairs) prediction with downstream WMH segmentation")
        print("="*60 + "\n")
...
if __name__ == "__main__":
    ...
    Usage: python experiments/flair_to_flair_dense_pairs_L1.py
    """
    print("\n" + "="*70)
    print("🧪 Running Experiment 3: FLAIR → FLAIR (dense pairs, L1)")
    print("="*70 + "\n")
